...
public class SaveValue {
    ...
    private String lastBackground = "BACKGROUND";
    private String timeDem = "TIME_DEM";
    private String timeDemXoaPass = "timeDemXoaPass";
    private String isLock = "LOCK";
    private String firstRun = "first_Run";
    private String haveToDay = "haveToDay";
...
//-------------------------------------------------------------------------
    public void setSaved_Time_Xoa_Pass_Long(Long i)
    {
        SharedPreferences.Editor localEditor = this.context
                .getSharedPreferences(this.save, 0).edit();
        localEditor.putLong(this.timeDemXoaPass, i);
        localEditor.commit();
    }

    public Long getSaved_Time_Xoa_Pass_Long()
    {
        return this.context.getSharedPreferences(this.save, 0)
                .getLong(this.timeDemXoaPass,0);
    }
...
//-------------------------------------------------------------------------
    ...
    {
        return this.context.getSharedPreferences(this.save, 0)
                .getBoolean(this.firstRun,true);
    }
//-------------------------------------------------------------------------
    public void setSaved_Last_Background_Integer(Integer i)
    {
        SharedPreferences.Editor localEditor = this.context
                .getSharedPreferences(this.save, 0).edit();
        localEditor.putInt(this.lastBackground, i);
        localEditor.commit();
    }

    public Integer getSaved_Last_Background_Integer()
    {
        return this.context.getSharedPreferences(this.save, 0)
                .getInt(this.lastBackground
                        , (MainActivity.arrHinhBackground.length() -1));
    }

//-------------------------------------------------------------------------
    public void setSaved_Have_Note_ToDay_Integer(Integer i)
    {
        SharedPreferences.Editor localEditor = this.context
                .getSharedPreferences(this.save, 0).edit();
        localEditor.putInt(this.haveToDay, i);
        localEditor.commit();
    }

    public Integer getSaved_Have_Note_ToDay_Integer()
    {
        return this.context.getSharedPreferences(this.save, 0)
                .getInt(this.haveToDay,0);
    }
